...
var today = new Date();
var currentDay = today.toLocaleDateString("fr-FR", {
  weekday: "long"
});
...
/* harmony export */ });
var apiKey = "e1c24fb45d4215b7c791b97fdecc48b9";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(332);
/* harmony import */ var _api_key_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(333);
...
var error = function error(err) {
  return console.warn("ERREUR (".concat(err.code, "): ").concat(err.message));
};

navigator.geolocation.getCurrentPosition(function (pos) {
  var latitude = pos.coords.latitude;
  var longitude = pos.coords.longitude;
  var endpointOpenWeather = "https://api.openweathermap.org/data/2.5/onecall?lat=".concat(latitude, "&lon=").concat(longitude, "&exclude=minutely&appid=").concat(_api_key_js__WEBPACK_IMPORTED_MODULE_1__.default, "&lang=").concat(lang, "&units=metric");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            imgWeather = document.querySelector("#imgWeather");
            imgWeather.innerHTML = "<img src=\"http://openweathermap.org/img/wn/".concat(jsonResponse.current.weather[0].icon, "@2x.png\">");
            descriptionWeather = document.querySelector("#description-weather");
            descriptionWeather.innerHTML = "".concat(jsonResponse.current.weather[0].description);
            currentTemperature = document.querySelector("#current-temperature");
            currentTemperature.innerHTML = "".concat(Math.trunc(jsonResponse.current.temp));
            timeZone = document.querySelector("#timezone");
            timeZone.innerHTML = "".concat(jsonResponse.timezone); // Call hour every 3 hours

            for (i = 0; i < $hours.length; i++) {
              incrHour = _utils_js__WEBPACK_IMPORTED_MODULE_0__.currentHour + i * 3;
            ...
            for (j = 0; j < $temperatureDetails.length; j++) {
              $temperatureDetails[j].innerHTML = "".concat(Math.trunc(jsonResponse.hourly[j * 3].temp));
            } // Call next days


            for (k = 0; k < _utils_js__WEBPACK_IMPORTED_MODULE_0__.seriesOfDays.length; k++) {
              $days[k].innerHTML = _utils_js__WEBPACK_IMPORTED_MODULE_0__.seriesOfDays[k].slice(0, 3);
            }

            (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.responsiveContentsTheadTable)($tableResponsive); // Call temperature's next days
